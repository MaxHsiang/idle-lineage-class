...
(function () {
    const PAGE_SLOTS = [
        [
            ...
            { k: 'special', alt: 'arrow', x: 80.1, y: 80.76, w: 19.67, h: 8.82 }
        ],
        [
            { k: 'rem_eye',       x: 50.0, y: 15.81, w: 19.67, h: 8.82 },
            { k: 'eye',           x: 19.4, y: 18.01, w: 19.67, h: 8.82 },
            { k: 'gen_oracle',    x: 80.1, y: 18.01, w: 19.67, h: 8.82 },
            { k: 'gen_soul',      x: 50.0, y: 33.46, w: 19.67, h: 8.82 },
            { k: 'rem_bone',      x: 19.4, y: 31.50, w: 19.67, h: 8.82 },
            { k: 'rem_blood',     x: 80.1, y: 31.50, w: 19.67, h: 8.82 },
            { k: 'gen_mantle',    x: 50.0, y: 42.77, w: 19.67, h: 8.82 },
            ...
            { k: 'gen_rune_l',    x: 19.4, y: 58.46, w: 19.67, h: 8.82 },
            { k: 'gen_rune_r',    x: 80.1, y: 58.46, w: 19.67, h: 8.82 },
            { k: 'rem_heart',     x: 50.0, y: 63.36, w: 19.67, h: 8.82 },
            { k: 'gen_hourglass', x: 19.4, y: 67.77, w: 19.67, h: 8.82 },
            { k: 'gen_nexus',     x: 80.1, y: 67.77, w: 19.67, h: 8.82 },
            { k: 'gen_kneeguard', x: 50.0, y: 72.67, w: 19.67, h: 8.82 },
            { k: 'rem_flesh',     x: 50.0, y: 81.99, w: 19.67, h: 8.82 },
            { k: 'gen_familiar',  x: 19.4, y: 80.76, w: 19.67, h: 8.82 },
            { k: 'gen_seal',      x: 80.1, y: 80.76, w: 19.67, h: 8.82 }
        ]
    ];
