...
(function () {
    ...
    const defs = {
        genesis_helm:   { n:'創世四龍神盔', type:'arm', slot:'helm',   ac:20, mr:30, str:10, int:10, wis:10, img:'assets/icons/genesis/genesis_helm.png', set:ARMOR_SET, d:'四龍神首共同守護的創世戰盔。' },
        genesis_tshirt: { n:'創世四龍神衣', type:'arm', slot:'tshirt', ac:15, mhp:1000, mmp:500, con:10, wis:10, img:'assets/icons/genesis/genesis_tshirt.png', set:ARMOR_SET, d:'貼身流動的創世神衣，能穩定生命與魔力。' },
        genesis_armor:  { n:'創世四龍神甲', type:'arm', slot:'armor',  ac:30, mhp:3000, dr:30, resFire:30, resWater:30, resWind:30, resEarth:30, img:'assets/icons/genesis/genesis_armor.png', set:ARMOR_SET, d:'以四龍逆鱗與黑色神鐵共同鑄造的主甲。' },
        genesis_cloak:  { n:'創世四龍神翼', type:'arm', slot:'cloak',  ac:18, mr:50, er:20, dex:10, img:'assets/icons/genesis/genesis_cloak.png', set:ARMOR_SET, d:'地水風火四種龍翼交疊形成的神聖斗篷。' },
        genesis_gloves: { n:'創世四龍神手', type:'arm', slot:'gloves', ac:15, extraHit:30, extraDmg:30, magicHit:30, str:10, int:10, img:'assets/icons/genesis/genesis_gloves.png', set:ARMOR_SET, d:'讓物理與魔法攻擊同樣精準的四龍護手。' },
        genesis_shield: { n:'創世四龍神盾', type:'arm', slot:'shield', ac:25, dr:40, mhp:1500, immStone:true, immPoison:true, resNone:30, img:'assets/icons/genesis/genesis_shield.png', set:ARMOR_SET, d:'環繞創世晶核的四龍守護壁；可與單手神劍並用。' },
        genesis_shin:   { n:'創世四龍神脛', type:'arm', slot:'shin',   ac:15, str:10, dex:10, con:10, int:10, wis:10, img:'assets/icons/genesis/genesis_shin.png', set:ARMOR_SET, d:'承載地脈力量、穩固全身能力的創世脛甲。' },
        genesis_boots:  { n:'創世四龍神靴', type:'arm', slot:'boots', ac:15, atkSpdPct:30, moveSpeedPct:30, hpR:30, mpR:20, img:'assets/icons/genesis/genesis_boots.png', set:ARMOR_SET, d:'踏出風雷與龍焰軌跡的創世神靴。' },

        genesis_ear_fire:  { n:'創世火龍神耳環', type:'acc', slot:'ear', ac:8, extraDmg:50, meleeDmg:20, mdmg:20, resFire:30, img:'assets/icons/genesis/genesis_ear_fire.png', set:ACC_SET, unique:true, d:'瓦拉卡斯龍焰凝成的毀滅耳環。' },
        genesis_ear_water: { n:'創世水龍神耳環', type:'acc', slot:'ear', ac:8, mhp:1000, mmp:1000, hpR:40, mpR:40, resWater:30, img:'assets/icons/genesis/genesis_ear_water.png', set:ACC_SET, unique:true, d:'法利昂生命潮汐凝成的治癒耳環。' },
        genesis_amulet:    { n:'創世風龍神項鍊', type:'acc', slot:'amulet', ac:10, extraHit:50, magicHit:50, er:30, atkSpdPct:30, resWind:30, img:'assets/icons/genesis/genesis_amulet.png', set:ACC_SET, unique:true, d:'林德拜爾疾風環繞的創世項鍊。' },
        genesis_ring_earth:{ n:'創世地龍控制戒', type:'acc', slot:'ring', ac:10, dr:30, con:15, mhp:1000, resEarth:30, polyCtrl:true, teleportCtrl:true, summonCtrl:true, img:'assets/icons/genesis/genesis_ring_earth.png', set:ACC_SET, unique:true, d:'安塔瑞斯大地之力凝成的控制戒指。穿戴或放在背包即可同時啟用召喚、傳送與變形控制。' },
        genesis_ring_water:{ n:'創世水龍治癒戒', type:'acc', slot:'ring', ac:10, mmp:1000, mpR:50, extraMp:40, resWater:30, img:'assets/icons/genesis/genesis_ring_water.png', set:ACC_SET, unique:true, d:'永不枯竭的水龍魔力泉源。' },
        genesis_ring_wind: { n:'創世風龍迅捷戒', type:'acc', slot:'ring', ac:10, rangedDmg:50, rangedHit:50, er:20, resWind:30, img:'assets/icons/genesis/genesis_ring_wind.png', set:ACC_SET, unique:true, d:'駕馭風暴與遠距攻擊的迅捷戒指。' },
        genesis_ring_fire: { n:'創世火龍毀滅戒', type:'acc', slot:'ring', ac:10, meleeDmg:50, mdmg:50, extraDmg:30, resFire:30, img:'assets/icons/genesis/genesis_ring_fire.png', set:ACC_SET, unique:true, d:'將近戰與魔法一同化為龍焰的毀滅戒指。' },
        genesis_belt:      { n:'四龍創世神腰帶', type:'acc', slot:'belt', ac:12, mhp:1500, mmp:1000, weightCap:1000, resFire:25, resWater:25, resWind:25, resEarth:25, img:'assets/icons/genesis/genesis_belt.png', set:ACC_SET, unique:true, d:'支撐四龍創世神力與無盡負重的神聖腰帶。' }
    };
    ...
    const genesisRemainImages = {
        rem_claw:'genesis_rem_claw', rem_eye:'genesis_rem_eye', rem_blood:'genesis_rem_blood', rem_flesh:'genesis_rem_flesh',
        rem_heart:'genesis_rem_heart', rem_bone:'genesis_rem_bone', rem_fang:'genesis_rem_fang', rem_scale:'genesis_rem_scale'
    };
    Object.keys(genesisRemainImages).forEach(function (id) {
        if (DB.items[id]) DB.items[id].img = 'assets/icons/genesis/' + genesisRemainImages[id] + '.png';
    });
