...
global.Genesis = { config:{version:'v1.6.17-dev'}, classSystem:{isGenesisPlayer:()=>true} };
let roster = [];
...
assert.ok(!DB.skills.sk_genesis_omni_summon);
...
console.log('Genesis content smoke test passed: Ultimate Land, native summon option, pass, collections, awakening and four deployed mini dragons.');
