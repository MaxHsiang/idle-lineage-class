...
assert.ok(launcherHtml.includes("location.replace('index.html?genesis=1&build=175')"), 'file launcher redirect missing');
assert.ok(gameHtml.includes('js/genesis/genesis-loader.js?v=1.6.15-static-bootstrap'), 'static genesis loader bootstrap missing');
