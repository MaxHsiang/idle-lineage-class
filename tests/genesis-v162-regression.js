...
assert.ok(index.includes('js/08-items-equip.js?v=v3.8.34-genesis-183'), 'item/status cache must be bumped');
assert.ok(index.includes('js/09-vfx-render.js?v=v3.8.34-genesis-179'), 'VFX cache must be bumped');
assert.ok(index.includes('1.6.22-ignore-defense-unlimited-panacea'), 'Genesis loader cache must be bumped');
